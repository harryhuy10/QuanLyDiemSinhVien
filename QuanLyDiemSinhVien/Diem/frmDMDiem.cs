...
{
    public partial class frmDMDiem : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void btnTimKiem_Click(object sender, EventArgs e)
        {
            ...
            {
                sqlSELECT = "select * from DMDiem where MaSV = '" + txtTimKiemDiem.Text + "'";
            ...
            if (radioMaMH.Checked == true)
            {
                sqlSELECT = "select * from DMDiem where MaMH = '" + txtTimKiemDiem.Text + "'";
                com = new SqlCommand(sqlSELECT, con);//thực thi câu lệnh trong SQL
                da = new SqlDataAdapter(com); //vận chuyển dữ liệu
                dt = new DataTable();//tạo 1 bảng ảo
                da.Fill(dt); //đổ dữ liệu vào bảng ảo
            ...
            {
                sqlSELECT = "select a.MaSV,a.MaMH,a.LanThi,a.DiemSo,a.DiemChu from DMDiem a inner join DMSV b on a.MaSV = b.MaSV where a.MaSV = '" + txtTimKiemDiem.Text + "' or a.MaMH ='" + txtTimKiemDiem.Text + "' or a.LanThi ='" + txtTimKiemDiem.Text + "' or b.TenSV like '%" + txtTimKiemDiem.Text + "%'";
                com = new SqlCommand(sqlSELECT, con);//thực thi câu lệnh trong SQL
                da = new SqlDataAdapter(com); //vận chuyển dữ liệu
                dt = new DataTable();//tạo 1 bảng ảo
                da.Fill(dt); //đổ dữ liệu vào bảng ảo
