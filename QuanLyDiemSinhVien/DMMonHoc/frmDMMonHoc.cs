...
{
    public partial class frmDMMonHoc : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void btnTimKiem_Click(object sender, EventArgs e)
        {
            ...
            SqlDataAdapter da;
            DataTable dt;
            sqlSELECT = "select * from DMMonHoc where MaMH = '"+txtTimKiemDiem.Text+"'or TenMH like N'%"+txtTimKiemDiem.Text+"%' ";
