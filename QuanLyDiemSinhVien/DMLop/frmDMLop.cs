...
{
    public partial class frmDMLop : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void btnTimKiem_Click(object sender, EventArgs e)
        {
            ...
            {
                sqlSELECT = "select * from DMLop where MaLop = '" + txtTimKiemDiem.Text + "'";
            ...
            if (radioMaKhoa.Checked == true)
            {
                sqlSELECT = "select * from DMLop where MaKhoa = '" + txtTimKiemDiem.Text + "'";
                com = new SqlCommand(sqlSELECT, con);//thực thi câu lệnh trong SQL
                da = new SqlDataAdapter(com); //vận chuyển dữ liệu
                dt = new DataTable();//tạo 1 bảng ảo
                da.Fill(dt); //đổ dữ liệu vào bảng ảo
            ...
            {
                sqlSELECT = "select * from DMLop where TenLop like N'%" + txtTimKiemDiem.Text + "%'";
                com = new SqlCommand(sqlSELECT, con);//thực thi câu lệnh trong SQL
                da = new SqlDataAdapter(com); //vận chuyển dữ liệu
                dt = new DataTable();//tạo 1 bảng ảo
                da.Fill(dt); //đổ dữ liệu vào bảng ảo
            ...
            {
                sqlSELECT = "select * from DMLop where MaKhoa = '" + txtTimKiemDiem.Text + "' or TenLop like N'%" + txtTimKiemDiem.Text + "%' or MaLop = '" + txtTimKiemDiem.Text + "'";
                com = new SqlCommand(sqlSELECT, con);//thực thi câu lệnh trong SQL
                da = new SqlDataAdapter(com); //vận chuyển dữ liệu
                dt = new DataTable();//tạo 1 bảng ảo
                da.Fill(dt); //đổ dữ liệu vào bảng ảo
